        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-foreground/80 mb-4 leading-relaxed text-left max-w-prose hyphens-auto">
              Proteciot is a free educational platform founded by <span className="font-bold text-transparent bg-clip-text animate-tab-gradient drop-shadow-sm">Koliyar Nikhil Durairaj</span>, who currently leads the initiative as Founder and IoT Systems Engineer. The platform mentors engineering students in IoT projects through live Zoom sessions, offering guidance on project ideas, circuit diagrams, presentations, and teamwork. 
            </p>
